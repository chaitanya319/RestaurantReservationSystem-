	...
	<section>
		<div class="container" id="home">
			<ul class="nav nav-tabs nav-justified">
				...
				<li><a href="#tab-owner" data-toggle="tab">Owner</a></li>
			</ul>
			<div id="content" class="tab-content">
				<div class="tab-pane active" id="tab-guest">
					<h6>Fill Entries for a Reservation</h6>
					<form role="form">
						<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-3">
								<div class="form-group">
									<label for="reserveSize">Party Size</label> <input
										type="number" class="form-control" id="reserveSize"
										placeholder="# Guests">
								</div>
							</div>
							<div class="col-sm-9">
						...
						<div class="text-center">
							...
							<button type="button" class="btn btn-link"><a href='ChangeReservation.jsp'> Change Existing Reservation </a></button>
						</div>
					</form>
				</div>
